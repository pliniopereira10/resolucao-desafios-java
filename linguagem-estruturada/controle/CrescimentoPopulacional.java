 ...
 *
 *	Arquivo:	CrescimentoPopulacional.java
 */
 ...
 public class CrescimentoPopulacional	{
 	...
 	public static void main (String[] args)	{
		...
		Scanner input = new Scanner(System.in);
			...
			int populacaoDeA, populacaoDeB;	//	recebe quant. da pop. da cid. A e cid. B, sendo que a pop. de B sempre maior que a de A.
			double taxaCrescA, taxaCrescB;	//	recebe a taxa de crescimento de cada cidade.
			int quantDeAnos;	//	recebe a quantidade de anos que será necessário para cidade A ultrapassar cid. B.
			...
			for(int contadorUm = 0; contadorUm < quantDeTestes; contadorUm++) {
				...
				quantDeAnos = 0;
				/*	
				 * 2º Loop para cálculo do tempo que pop. de A excederá pop. de B,
				 * não sendo necessário continuar o loop quando quant de anos for maior
				 * que 100.
				 */
